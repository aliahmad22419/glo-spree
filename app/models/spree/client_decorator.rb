  ...
  module ClientDecorator
    def self.prepended(base)
      base.preference :enable_auto_exchange_rates, :boolean, default: false
			base.preference :exchange_rates_schedule, :string, default: "once_day" # rubocop:disable Layout/IndentationStyle
      ...
      base.whitelisted_ransackable_attributes = %w[name email]
      ...
      base.has_and_belongs_to_many :service_login_sub_admins, class_name: "Spree::ServiceLoginUser", join_table: "spree_clients_service_login", foreign_key: "client_id", association_foreign_key: "service_login_sub_admin_id"

...
pdf.text "<b>#{I18n.with_locale(@doc.store_locale) { I18n.t('pdf.gift_card.details.value') }}</b><b>:</b> #{@doc.card_currency.to_s} #{@doc.total}", inline_format: true, size: normal_text_size, align: :center
pdf.move_down 10
